              ...
              child: Column(
                children: [
                  ...
                  _buildMenuItem(
                    ...
                    subtitle:
                        "${profile?.gender ?? ''} ${location.isNotEmpty ? '• $location' : ''}",
                    onTap: () {
                  ...
                  _buildMenuItem(
                    ...
                    subtitle:
                        "${profile?.languages?.isNotEmpty == true ? profile?.languages?.join(', ') : 'Not set'}",
                    onTap: () {
                  ...
                  _buildMenuItem(
                    ...
                    subtitle:
                        "${profile?.workExperience?.length ?? 0} positions",
                    onTap: () {
                  ...
                  _buildMenuItem(
                    ...
                    title: "Education",
                    subtitle: "${profile?.education?.length ?? 0} qualifications",
                    onTap: () {
                  ...
                  _buildMenuItem(
                    ...
                    title: "Portfolio",
                    subtitle: "${profile?.portfolio?.length ?? 0} projects",
                    onTap: () {
